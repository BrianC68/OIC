...
if os.name == "nt":
    lrs_path = "C:\\Users\\brian\\Documents\\Python\\OIC\\south\\"
else:
    lrs_path = "/home/pi/OIC/south/"

def application(files):
    """Main Application: Accepts list of files in the OIC/south directory"""
    font = "Verdana"
    font_size = 10
    root = Tk()
    root.title("Edit South Locker Rooms")
...
def get_locker_room_assgnmnt_files_list():
    """Read file names in OIC/south folder"""
